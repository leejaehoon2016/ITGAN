...
class UniformSynthesizer(BaseSynthesizer):
    ...
    def fit(self, train_data, test_data, meta_data, dataset_name, categorical_columns=tuple(), ordinal_columns=tuple()):
        ...
        self.save_result_type1(train_data, test_data, self.meta2, "UniformSynthesizer")
...
if __name__ == "__main__":
    ...
    with open(save_loc + "/param/"+ data + "/" + test_name + '.txt',"a") as f:
        f.write(data + " UniformSynthesizer" + "\n")
        f.write(str(arg) + "\n")

    a,b = benchmark(UniformSynthesizer, arg, data)
    print(a.mean(),b)
