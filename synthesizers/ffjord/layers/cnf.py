...
from .torchdiffeq import odeint as odeint_original
...
class CNF(nn.Module):
    def __init__(self, odefunc, T=1.0, train_T=False, regularization_fns=None, solver='dopri5', mode = 1, atol=1e-5, rtol=1e-5, 
                adjoint = True):
